                    ...
                    <div className="account">
                        <div className="account__section">
                            <form onSubmit={userRegister} >
                                ...
                                <div className="group">
                                    <input type="text" name="firstName" value={state.firstName} onChange={handleInputs} placeholder="eg: John" className="group__control" />
                                </div>
                                <div className="group">
                                    <input type="text" name="lastName" value={state.lastName} onChange={handleInputs} placeholder="eg: Doe" className="group__control" />
                                </div>
                                <div className="group">
